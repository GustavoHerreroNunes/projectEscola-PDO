...
--
-- Host: 127.0.0.1
-- Generation Time: 10-Ago-2020 às 14:08
...
-- Database: `escola`
--
CREATE DATABASE IF NOT EXISTS `db_escola` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_escola`;
-- --------------------------------------------------------
