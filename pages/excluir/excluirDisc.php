...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>UJB - Excluir Disciplina</title>
        ...
        <div id="Conteudo">
            ...
            <form name="cliente" method="POST" action="">
                <fieldset>
                    ...
                    <legend><b>Informe o Código da Disciplina</b></legend>
                    <br>
                        <p>
                            Código:
                ...
                <fieldset>
                    ...
                    <input type="reset" name="btnLimpar" value="Limpar" onClick="document.cliente.txbCodc.focus()" id="button">
